...
<head>
  ...
  <title>DCRMS ! Rider's profile</title>
</head>
        ...
        <form action="" method="post" action="adminEditRiderProfile.php">
		 <input type="hidden"  name="id" value="<?php echo $id ?>">
          <div id="customer-details-info">
			...
			<div class="form-group ">
              <div class="edit">
                <label for="liciense_no">Liciense Number: </label>
                <input type="text" name="liciense_no" class="form-control form-control-lg <?php echo (!empty($data['liciense_no_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['liciense_no']; ?>">
              </div>
              <span class="invalid">
