            ...
            <td>
                <select class="form-control form-control-sm" name="reg_status">
                  <option selected value="<?php echo $runner->R_AccStatus; ?>"> <?php echo $runner->R_AccStatus; ?></option>
				    <option value="ACCOUNT IS VALID"> Account Is Valid </option>
                  <option value="ACCOUNT IS BANNED"> Ban The Account </option>
                  <option value="ACCOUNT IS UNBAN"> Unban The Account</option>
                </select>
              </td>
